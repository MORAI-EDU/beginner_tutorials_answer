...
class DijkstraPathPub(Node):
    def __init__(self):
        ...
        self.start_node = 'A1256W000792'
        self.end_node = 'A1256W000034'
...
def main(args=None):
    ...
    dijkstra_path_pub = DijkstraPathPub()
    
    try:
        rclpy.spin(dijkstra_path_pub)
    except KeyboardInterrupt:
        pass
    finally:
        dijkstra_path_pub.destroy_node()
        rclpy.shutdown()
